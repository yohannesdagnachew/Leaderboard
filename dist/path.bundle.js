 ...
 */
(self["webpackChunkleaderboard"] = self["webpackChunkleaderboard"] || []).push([["path"],{
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style/main.css */ \"./src/style/main.css\");\n/* harmony import */ var _js_createlement_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/createlement.js */ \"./src/js/createlement.js\");\n/* harmony import */ var _js_generate_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/generate.js */ \"./src/js/generate.js\");\n\n\n\n\nconst add = document.querySelector('#submit');\nconst refbtn = document.querySelector('#refresh');\n\n(0,_js_generate_js__WEBPACK_IMPORTED_MODULE_2__.generate)();\n\nconst newFunc = () => {\n  const user = document.querySelector('#name');\n  const score = document.querySelector('#score');\n  const inputFile = {\n    user: user.value,\n    score: score.value,\n  };\n  (0,_js_createlement_js__WEBPACK_IMPORTED_MODULE_1__.getPost)(inputFile);\n  user.value = '';\n  score.value = '';\n};\n\nadd.addEventListener('click', (e) => {\n  e.preventDefault();\n  newFunc();\n});\n\nrefbtn.addEventListener('click', (e) => {\n  e.preventDefault();\n  (0,_js_generate_js__WEBPACK_IMPORTED_MODULE_2__.generate)();\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");

/***/ }),

/***/ "./src/js/createlement.js":
/*!********************************!*\
  !*** ./src/js/createlement.js ***!
  \********************************/
/***/ ((__unused_webpack_module, exports) => {

eval("const url = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/ljmGTCiQ0bLn1cM60koG/scores';\nconst getPost = async (inputFile) => {\n  const response = await fetch(url, {\n    method: 'POST',\n    headers: {\n      'Content-Type': 'application/json',\n    },\n    body: JSON.stringify(inputFile),\n  });\n  await response.json();\n};\nexports.getPost = getPost;\n\n\n//# sourceURL=webpack://leaderboard/./src/js/createlement.js?");
